...
import { Mail, Phone, MessageCircle, Globe, Users, Send, MapPin, Clock, CheckCircle, X } from 'lucide-react';
...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      data.append('sheetName', 'SaloonResponse');
      ...
      showPopup('success', 'Thank you for your message! We\'ll get back to you soon.');
      setFormData({ name: '', email: '', phone: '', message: '' });
    } catch (err) {
      console.error('Error submitting contact form:', err);
      showPopup('error', 'Sorry, there was a problem submitting your message. Please try again later.');
    } finally {
      setSubmitting(false);
    }
  };
            ...
            <div className="p-6">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 text-sm">{popup.message}</p>
                </div>
                <button
                  onClick={hidePopup}
